			                ...
			                <tbody>
			                	<?php
			                		foreach ($listgroup as $group) {
			                			?>
			                				<tr>
						                		<td><a style="cursor: pointer;" class="user-name" onclick="createTab('<?php echo base_url()?>groupuser/groupuserdetail?groupid=<?php echo $group['groupid']; ?>','<?php echo $group['groupname']; ?>')"><?php  echo $group['groupname'];?></a></td>
						                		<td><!--15 người--></td>
						                		<td>
