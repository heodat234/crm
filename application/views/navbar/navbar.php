<header class="app-header">
       <ul class="nav nav-tabs nav-menu main-nav" role="tablist">
            ...
            <li class="nav-item width-170" role="presentation">
                <a class="nav-link active show" role="tab" data-toggle="tab" href="#tab" title="Ticket">
        ...
        <ul class="nav-insert">
            <li class="dropdown dropdown-left" id="li-main">
              ...
              <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li><a class="dropdown-item add-contact" title="Insert Ticket" alt="<?php echo base_url().'ticket/viewInsert/' ?>" href="#"><i class="fa fa-file-alt fa-fw"></i> Thêm Ticket</a></li>
                <?php } ?>
                <li><a class="dropdown-item add-contact" title="Insert User" alt="<?php echo base_url().'user/create' ?>" href="#"><i class="fa fa-user fa-lg"></i> Thêm User</a></li>
              </ul>
            </li>
        </ul>
            
            <!-- <li class="nav-item dropdown">
                <a class="nav-link" aria-expanded="false" data-toggle="tab" href="#add" data-toggle="dropdown"> 
                    <i class="fa fa-plus fa-lg"></i> 
                Thêm</a>
                <ul class="dropdown-menu settings-menu dropdown-menu-right show" x-placement="bottom-end" style="position: absolute; transform: translate3d(-116px, 44px, 0px); top: 0px; left: 0px; will-change: transform;">
                <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-cog fa-lg"></i> Settings</a></li>
                <li><a class="dropdown-item" href="page-user.html"><i class="fa fa-user fa-lg"></i> Profile</a></li>
                <li><a class="dropdown-item" href="http://crm.tavicosoft.com/login/logout"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
              </ul>
            </li> -->
      	...
      	<ul class="app-nav">
	        ...
	        <li class="dropdown">
	          ...
	          <div id="phone-chat" class="dropdown-menu settings-menu dropdown-menu-right" extension="" style="width: 241px; padding: 5px;">
	          	...
	          	<div id="c-phone-option" class="margin-right-10 margin-left--5">
                ...
                <div id="has-call-pad" class="text-center">
                    ...
                    <div id="are-b-has" class="col-md-12 flex no-padding font-size-12">
                        <!-- <div class="col-md-6 no-padding padding-right-5">
                            <a id="accept-call" href="#" class="btn btn-primary btn-block flatbtn margin-top-10">Chấp nhận</a>
                        </div> -->
