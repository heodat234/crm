	            ...
	            <div class="tile-body padding-left-10">
	            	<div class="">
	            		...
	            		<select name="group" class="control-label col-md-8 no-border no-padding margin-left-10" value="<?php echo isset($knowledge[0]['groupid'])?$knowledge[0]['groupid']:'' ?>">
	              		...
	              		<!-- <label class="control-label col-md-8 col-71 no-padding-right">
		              		<input name="group" class="col-md-12 no-padding font-size-12" list="i-group" value="<?php echo isset($knowledge[0]['groupid'])?$knowledge[0]['groupid']:'' ?>">
		              		<datalist id="i-group">
		              			<option selected="" value="1">Phân loại</option>
	            	...
	            	<div class="">
	            		...
	            		<select name="cate" class="control-label col-md-8 no-border no-padding margin-left-10" value="<?php echo isset($knowledge[0]['categoryid'])?$knowledge[0]['categoryid']:'' ?>">
	              		...
	              		<!-- <label class="control-label col-md-8 col-71 no-padding-right">
		              		<input name="category" class="col-md-12 no-padding font-size-12" list="i-cate" value="<?php echo isset($knowledge[0]['categoryid'])?$knowledge[0]['categoryid']:'' ?>">
		              		<datalist id="i-cate">
	            	...
	            	<div class="">
	            		...
	            		<select name="type" class="control-label col-md-8 no-border no-padding margin-left-10" value="<?php echo isset($knowledge[0]['tickettype'])?$knowledge[0]['tickettype']:'' ?>">
	              		...
	              		<!-- <label class="control-label col-md-8 col-71 no-padding-right">
		              		<input name="type" class="col-md-12 no-padding font-size-12" list="i-type" value="<?php echo isset($knowledge[0]['tickettype'])?$knowledge[0]['tickettype']:'' ?>">
		              		<datalist id="i-type">
	            ...
	            <div class="tile-body padding-left-10">
	            	...
	            	<div class="">
	            		...
	            		<select name="status" class="control-label col-md-8 no-border no-padding margin-left-10" value="<?php echo isset($knowledge[0]['hidden'])?$knowledge[0]['hidden']:'' ?>">
	              		...
	              		<!-- <label class="control-label col-md-8 col-71 no-padding-right">
		              		<input name="status" class="col-md-12 no-padding font-size-12" list="i-stt" value="<?php echo isset($knowledge[0]['hidden'])?$knowledge[0]['hidden']:'' ?>">
		              		<datalist id="i-stt">
