	            ...
	            <div class="tile-body">
	            	<div class="">
	            		<label class="control-label user-label col-md-3 no-padding">Mã giao dịch:</label>
	              		<label class="control-label col-md-8 no-padding-right col-brk-8"><a href="http://demo.tavicosoft.com/connectdb/loginprovider?opid=C0001@AGT&returnUrl=%2F%23PCT&token=<?php echo $token['data'] ?>&dataseg=contractid%3D<?php echo $trade[0]['contractid'] ?>%26action%3DV" target="_blank"><?php echo $trade[0]['contractid'] ?></a></label>
	            	</div>
	            	<div class="">
	            ...
	            <div class="tile-body">
	            	<div class="">
	            		<label class="control-label user-label col-md-3 no-padding">Mã KH</label>
	              		<label class="control-label col-md-8 no-padding-right"><a href="http://demo.tavicosoft.com/connectdb/loginprovider?opid=C0001@AGT&returnUrl=%2F%23NAD&token=<?php echo $token['data'] ?>&dataseg=nadcode%3D<?php echo $trade[0]['clientcode'] ?>%26action%3DV" target="_blank"><?php echo $trade[0]['clientcode'] ?></a></label>
	            	</div>
	            	<div class="">
          	...
          	<div class="tile p-0 padding-5 margin-bot-5">
	            <div class="tile-body">
	            	...
	            	<div class="">
	            		...
	            		<!-- <label class="control-label user-label col-md-3 no-padding">Số HĐ cọc</label>
	              		<label class="control-label col-md-8 no-padding-right"><?php echo $trade[0]['anal_pct6'] ?></label> -->
	            	</div>
	            </div>
          	</div>
          	<div class="tile p-0 padding-5 margin-bot-5">
